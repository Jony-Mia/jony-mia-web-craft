          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">
                WordPress Developer & Data Entry Expert
              </h3>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-4 py-2 bg-orange-100 text-orange-800 rounded-full text-sm font-medium">Data Entry Expert</span>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                <h4 className="text-xl font-semibold text-gray-900 mb-4">Data Entry & Technical Skills</h4>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex items-center">
