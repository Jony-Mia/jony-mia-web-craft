          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">
                WordPress Developer & Web Craftsman
              </h3>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Beyond WordPress, I'm proficient in React development, PHP programming, 
                and modern frontend technologies. I believe in creating scalable, 
                secure, and SEO-friendly solutions that deliver exceptional user experiences.
              </p>
              <div className="flex flex-wrap gap-3">
                ...
                <span className="px-4 py-2 bg-orange-100 text-orange-800 rounded-full text-sm font-medium">Problem Solver</span>
              </div>
            </div>
